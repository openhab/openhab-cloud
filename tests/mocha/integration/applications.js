...
describe('Applications', function () {
    ...
    it('Open Applications page with correct credentials', function (done) {
        testSession.get('/applications')
            .expect(200)
            .end(function (err, res) {
                var containedItem = res.text.indexOf('<h1 class="span8">Applications</h1>');
